  ...
  <span>VILA NOVA DE FAMALICÃO</span>
</h1>        <p className="text-white/60 text-sm tracking-[0.25em] uppercase mt-1">Jiu-Jitsu</p>
      </div>
      ...
      <div className="flex-1 bg-gb-gray flex items-start justify-center p-6 pt-8">
        <div className="w-full max-w-sm">
          ...
          <p className="text-gray-500 text-sm mb-8">Acesse sua conta na Gracie Barra Vila Nova de Famalicão</p>
          <LoginForm />
        </div>
      </div>
    </div>
